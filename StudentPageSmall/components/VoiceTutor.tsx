...
const VoiceTutor: React.FC<VoiceTutorProps> = ({ targetLanguage, onAction }) => {
  ...
  // Effect to handle auto-scrolling to the latest message
  useEffect(() => {
          ...
          <div className="w-full mt-12 text-left bg-slate-50 p-6 rounded-3xl border border-slate-100">
            ...
            {transcriptions.length === 0 ? (
              ...
              <div 
                ...
                className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar transition-all scroll-smooth"
              >
